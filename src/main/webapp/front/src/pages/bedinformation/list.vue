...
<div>
    ...
    <el-form :inline="true" :model="formSearch" class="list-form-pv" :style='{"padding":"30px 7% 0","alignItems":"center","background":"none","display":"flex","width":"100%","justifyContent":"center","height":"auto"}'>
      <el-form-item :style='{"margin":"0 4px 0 0","justifyContent":"center","display":"flex"}'>
	    <div class="lable" v-if="true" :style='{"width":"auto","padding":"0 10px","lineHeight":"42px","fontSize":"16px","display":"inline-block"}'>hospitalbednumber</div>
        <el-input v-model="formSearch.hospitalbednumber" placeholder="hospitalbednumber" clearable></el-input>
      </el-form-item>
      <el-form-item :style='{"margin":"0 4px 0 0","justifyContent":"center","display":"flex"}'>
		<div class="lable" v-if="true" :style='{"width":"auto","padding":"0 10px","lineHeight":"42px","fontSize":"16px","display":"inline-block"}'>usestatus</div>
        <el-select v-model="formSearch.usestatus" placeholder="请选择usestatus" :clearable="true">
          <el-option v-for="(item, index) in usestatusOptions" :key="index" :label="item" :value="item"></el-option>
        </el-select>
      </el-form-item>
	  ...
	  <el-button v-if="isAuth('bedinformation','新增')" :style='{"cursor":"pointer","border":"0","padding":"0px 15px","margin":"0 10px 0 0","outline":"none","color":"#fff","borderRadius":"4px","background":"#1e8892","width":"auto","fontSize":"16px","lineHeight":"42px","height":"42px"}' type="primary" @click="add('/index/bedinformationAdd')"><i v-if="true" :style='{"color":"#fff","margin":"0 10px 0 0","fontSize":"16px"}' class="el-icon-circle-plus-outline"></i>添加</el-button>
    </el-form>
  ...
  export default {
    ...
    methods: {
      ...
      getList(page, fenlei, ref = '') {
        ...
        let searchWhere = {};
        if (this.formSearch.hospitalbednumber != '') searchWhere.hospitalbednumber = '%' + this.formSearch.hospitalbednumber + '%';
        if (this.formSearch.usestatus != '') searchWhere.usestatus = this.formSearch.usestatus;
        this.$http.get('bedinformation/list', {params: Object.assign(params, searchWhere)}).then(res => {
          if (res.data.code == 0) {
      ...
      toDetail(item) {
        this.$router.push({path: '/index/bedinformationDetail', query: {detailObj: JSON.stringify(item)}});
      },
    }
  }
</script>
